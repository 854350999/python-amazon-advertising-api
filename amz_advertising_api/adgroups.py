...
class Adgroups(MainBaseApi):
    def get(self, adgroupId):
        """通过ID检索广告组"""
        self.url_path = '/v2/sp/adGroups/{adGroupId}'.format(adGroupId=adgroupId)
        self.method = 'get'
        return self.make_call()
    def get_extended(self, adgroupId):
        """通过ID检索广告组以及其他属性"""
        self.url_path = '/v2/sp/adGroups/extended/{adGroupId}'.format(adGroupId=adgroupId)
        self.method = 'post'
        return self.make_call()
    ...
    def list_extended(self, params):
        ...
        self.url_path = '/v2/sp/adGroups/extended'
        self.method = 'get'
        self.data = params
        return self.make_call()